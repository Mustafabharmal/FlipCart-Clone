...
`
    ...
    return (
        ...
        <span className={styles.userDetails}>Mustafa Bharmal</span>
        </div>
       ...
       {!delivered ? <> <div style={{justifyContent:"space-between",backgroundColor:"#2874f0",color:"white"}} className={`${styles.login} ${styles.divs}`}>
        ...
        <div style={{display:"flex",marginTop:"10px"}}>
            ...
            <div className={styles.addressLabel} ><span style={{fontWeight:"500",marginBottom:"20px"}}>Mustafa Bharmal, 7817878653</span><br/>
            Upleta, Gujarat</div>
        </div>
        ...
        <div>
        <p style={{color:"black",fontWeight:"400"}}>order confirmation email will be sent to <span style={{fontWeight:"500"}}> Mustafa@gmail.com</span> 
